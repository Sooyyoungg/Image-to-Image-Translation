...
import functools
from Encoder_Decoder import ResEncoder, Decoder
...
class smri2scalarGen(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, params):
        ...
        self.dec = Decoder(n_downsample, n_res, self.enc.output_dim, output_dim, res_norm='in', activ='none', pad_type=pad_type)
